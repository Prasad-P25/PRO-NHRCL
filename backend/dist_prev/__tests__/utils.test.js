...
describe('Compliance Calculation', () => {
    ...
    const calculateCompliance = (compliant, nonCompliant, na) => {
...
describe('KPI Formula Calculations', () => {
    ...
    const calculateLTIFR = (lostTimeInjuries, manHours) => {
        if (manHours === 0)
            return null;
...
describe('CAPA Number Generation', () => {
    const generateCAPANumber = (year, count) => {
...
describe('Audit Number Generation', () => {
    const generateAuditNumber = (packageCode, year, count) => {
