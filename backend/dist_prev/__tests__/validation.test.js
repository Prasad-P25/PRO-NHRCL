...
describe('Audit Type Validation', () => {
    const validAuditTypes = ['Full', 'Partial', 'Focused'];
    const isValidAuditType = (type) => {
        return validAuditTypes.includes(type);
    };
...
describe('Response Status Validation', () => {
    const validStatuses = ['C', 'NC', 'NA', 'NR'];
