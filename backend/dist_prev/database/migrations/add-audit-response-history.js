...
async function runMigration() {
    try {
        logger_1.logger.info('Running migration: add-audit-response-history...');
        await connection_1.db.query(migration);
...
runMigration();
//# sourceMappingURL=add-audit-response-history.js.map