...
async function addMoreKPIData() {
    ...
    const packages = await connection_1.db.query('SELECT id FROM packages');
    const indicators = await connection_1.db.query('SELECT id, name, type FROM kpi_indicators');
...
//# sourceMappingURL=add-kpi-data.js.map